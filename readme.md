...
O Lovelace deve ser lido como uma infraestrutura experimental de classificacao arquivistica. Ele demonstra que modelos genericos podem ser adaptados a tarefas documentais com ganhos relevantes, mas tambem mostra que a parte mais importante nao e apenas o modelo: e o desenho do fluxo inteiro.

Os dois estudos supervisionados, RVL-CDIP e JurisTCU, constituem os resultados principais consolidados ate aqui. A pasta `Lovelace_old_Sem_Supervisão_Humana` permanece como piloto separado de aprendizado sem supervisao humana, ainda sem fechamento experimental.

Do OCR ao prompt, do split ao hash, do checkpoint ao PREMIS, cada etapa importa para que o resultado seja computacionalmente util e arquivisticamente defensavel.
